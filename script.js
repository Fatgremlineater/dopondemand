// Autofill business fields if logged in
const user = JSON.parse(localStorage.getItem("dod_user"));
const isBusiness = new URLSearchParams(window.location.search).get("type") === "business";

if (user && isBusiness) {
  document.getElementById("bizname").value = user.businessName || "";
  document.getElementById("contactperson").value = user.contactPerson || "";
  document.getElementById("phonebiz").value = user.phone || "";
  document.getElementById("emailbiz").value = user.email || "";
  document.getElementById("vat").value = user.vat || "";
  document.getElementById("addressbiz").value = user.address || "";
}
